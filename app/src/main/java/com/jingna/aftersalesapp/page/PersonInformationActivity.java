...
import com.jingna.aftersalesapp.dialog.InformationNicknameDialog;
import com.jingna.aftersalesapp.dialog.InformationSexDialog;
...
public class PersonInformationActivity extends BaseActivity {
                    ...
                    public void onSuccess(String data) {
                        try {
                            ...
                            if(jsonObject.optString("status").equals("200")){
                                ...
                                Glide.with(context).load(NetUrl.BASE_URL+bean.getData().getHeadPhoto()).into(ivAvatar);
    ...
    private void onNickname(final String name) {
        ...
        ViseHttp.POST(NetUrl.EngineerUsertoUpdate)
                .addParam("id", SpUtils.getUserId(context))
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE && data != null) {
            ...
            ViseHttp.UPLOAD(NetUrl.EngineerUsertoUpdate)
                    .addParam("id", SpUtils.getUserId(context))
                    .addFile("file0", file)
                    .request(new ACallback<String>() {
                        @Override
